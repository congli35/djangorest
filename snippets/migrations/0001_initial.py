...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'snippets_snippet', (
            ...
            ('languages', self.gf('django.db.models.fields.BooleanField')(default=True, max_length=100)),
    ...
    models = {
        u'snippets.snippet': {
            ...
            'languages': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'max_length': '100'}),
